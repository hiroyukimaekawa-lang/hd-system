...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const PRESET_GENRES_MAP = {
    // ── 既存業種 ──
    'カフェ': ['カフェ', 'コーヒーショップ', '喫茶店', '珈琲'],
    'スイーツ': ['スイーツ', 'ケーキ', 'デザート', '洋菓子', '和菓子', 'ペーストリー', '菓子店', 'ケーキ屋', 'アイスクリーム', 'パティスリー'],
    'ラーメン': ['ラーメン', '中華そば', '拉麺', 'ラーメン店'],
    '居酒屋': ['居酒屋', 'バル', 'バー', '酒場', '立ち飲み', 'ダイニングバー'],
    '焼肉': ['焼肉', 'ホルモン', '肉料理', 'ステーキ', 'バーベキュー', '焼肉店'],
    '寿司': ['寿司', '鮨', 'すし', '回転寿司', '寿司屋'],
    'イタリアン': ['イタリアン', 'イタリア料理', 'パスタ', 'ピザ'],
    'フレンチ': ['フレンチ', 'フランス料理', 'ビストロ'],
    '和食': ['和食', '日本料理', '割烹', '懐石', '定食', 'そば', 'うどん'],
    '中華': ['中華', '中華料理', '餃子', 'チャーハン'],
    '喫茶店': ['喫茶店', '純喫茶', '喫茶'],
    'ベーカリー': ['ベーカリー', 'パン屋', 'サンドイッチ'],

    // ── 今回追加 ──
    'お好み焼き': ['お好み焼き', 'お好み焼き店', 'たこ焼き', '鉄板焼き'],
    '焼きとり': ['焼きとり', '焼き鳥', '焼鳥', '鳥料理', 'とり料理'],
    'バー': ['バー', 'カクテルバー', 'ワインバー', 'ビアバー', 'ショットバー'],
    'スナック': ['スナック', 'スナックバー', 'クラブ', 'ラウンジ'],
  };
